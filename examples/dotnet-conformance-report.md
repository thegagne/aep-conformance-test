...
**Generated:** 2026-07-12T02:37:44Z  
...
| PASS   | AEP-102 | MUST  | `api-name-format`       | api name: bookstore.example.com       |
...
| status | AEP     | level      | check                                    | detail                                                                    |
| :----- | :------ | :--------- | :--------------------------------------- | :------------------------------------------------------------------------ |
| PASS   | AEP-4   | MUST       | `resource-type-format`                   | type: bookstore.example.com/publisher                                     |
...
| PASS   | AEP-122 | MUST       | `path-matches-canonical-pattern`         | returned path matches canonical pattern: publishers/aepconf-publisher-1   |
...
| PASS   | AEP-133 | MUST       | `create-path-field-ignored`              | client path ignored; server path = publishers/aepconf-publisher-3         |
| PASS   | AEP-133 | MUST       | `create-populates-path`                  | path = publishers/aepconf-publisher-1                                     |
...
| FAIL   | AEP-135 | MUST       | `delete-cascade-requires-force`          | resource has children but Delete has no 'force' flag                      |
...
| FAIL   | AEP-137 | MUST       | `apply-preserves-absent-fields`          | omitted field "display_name" was modified by Apply (display_name → <nil>) |
...
| PASS   | AEP-154 | MUST       | `etag-changes-on-update`                 | ETag changed after update                                                 |
| PASS   | AEP-154 | MUST       | `if-match-mismatch-412`                  | 412 on stale If-Match                                                     |
...
| PASS   | AEP-158 | MUST       | `page-size-negative-invalid`             | 400 on negative page size                                                 |
...
| PASS   | AEP-193 | SHOULD     | `error-body-rfc9457-shape`               | error body has type/status/title                                          |
| PASS   | AEP-193 | SHOULD     | `error-content-type-json`                | content-type: application/problem+json                                    |
| PASS   | AEP-193 | SHOULD     | `error-status-matches-http`              | status matches HTTP code                                                  |
| PASS   | AEP-193 | MUST       | `error-type-uri`                         | type = https://tools.ietf.org/html/rfc9110#section-15.5.5                 |
...
| status | AEP     | level      | check                                    | detail                                                                                       |
| :----- | :------ | :--------- | :--------------------------------------- | :------------------------------------------------------------------------------------------- |
| PASS   | AEP-4   | MUST       | `resource-type-format`                   | type: bookstore.example.com/book                                                             |
...
| PASS   | AEP-122 | MUST       | `path-field-present`                     | path field present                                                                           |
| PASS   | AEP-122 | MUST       | `path-field-readonly`                    | path is readOnly                                                                             |
| PASS   | AEP-122 | MUST       | `path-matches-canonical-pattern`         | returned path matches canonical pattern: publishers/aepconf-publisher-8/books/aepconf-book-9 |
...
| PASS   | AEP-133 | MUST       | `create-echoes-input`                    | all sent fields echoed                                                                       |
| PASS   | AEP-133 | MUST NOT   | `create-no-required-query`               | no required query fields on Create                                                           |
| PASS   | AEP-133 | MUST       | `create-path-field-ignored`              | client path ignored; server path = publishers/aepconf-publisher-8/books/aepconf-book-11      |
| PASS   | AEP-133 | MUST       | `create-populates-path`                  | path = publishers/aepconf-publisher-8/books/aepconf-book-9                                   |
| PASS   | AEP-133 | MUST       | `create-returns-resource`                | create returned resource                                                                     |
| PASS   | AEP-134 | MUST       | `update-404-on-missing`                  | 404 on missing update                                                                        |
| PASS   | AEP-134 | MUST       | `update-consistent-on-get`               | update observed on subsequent Get                                                            |
| PASS   | AEP-134 | SHOULD     | `update-fully-populated`                 | update response fully populated                                                              |
...
| N/A    | AEP-136 | MUST       | `custom-verb-snake-case`                 | feature not present in spec                                                                  |
| FAIL   | AEP-137 | MUST       | `apply-create-201`                       | apply created a resource but returned 200, expected 201                                      |
| FAIL   | AEP-137 | MUST       | `apply-preserves-absent-fields`          | omitted field "author" was modified by Apply (author → <nil>)                                |
| PASS   | AEP-137 | MUST       | `apply-consistent-on-get`                | apply observed on subsequent Get                                                             |
| PASS   | AEP-137 | SHOULD     | `apply-fully-populated`                  | apply response fully populated                                                               |
| PASS   | AEP-137 | MUST       | `apply-missing-required-400`             | 400 on apply missing a required field                                                        |
| PASS   | AEP-137 | MUST       | `apply-response-is-resource`             | apply returned resource                                                                      |
| PASS   | AEP-137 | MUST       | `apply-update-200`                       | 200 OK on apply-update                                                                       |
| PASS   | AEP-140 | SHOULD     | `field-avoid-reserved-keywords`          | all fields conform                                                                           |
| PASS   | AEP-140 | SHOULD     | `field-bool-no-is-prefix`                | all fields conform                                                                           |
...
| PASS   | AEP-158 | MUST       | `page-size-negative-invalid`             | 400 on negative page size                                                                    |
| PASS   | AEP-158 | MUST       | `page-terminates`                        | pagination reached end in 3 page(s)                                                          |
| PASS   | AEP-159 | MUST       | `across-collections-real-parent-ids`     | wildcard list returned 6 resources with canonical parent ids                                 |
| PASS   | AEP-160 | MUST       | `filter-invalid-argument`                | 400 on invalid filter                                                                        |
| PASS   | AEP-160 | SHOULD     | `filter-single-field-named-filter`       | filter field present                                                                         |
| N/A    | AEP-162 | MUST       | `revision-collection-named-revisions`    | feature not present in spec                                                                  |
| N/A    | AEP-164 | SHOULD     | `soft-delete-show-deleted-bool`          | feature not present in spec                                                                  |
...
| status | AEP     | level      | check                                    | detail                                                                                                                     |
| :----- | :------ | :--------- | :--------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- |
| PASS   | AEP-4   | MUST       | `resource-type-format`                   | type: bookstore.example.com/chapter                                                                                        |
| PASS   | AEP-122 | MUST       | `collection-id-format`                   | collection id: chapters                                                                                                    |
| PASS   | AEP-122 | MUST       | `collection-id-plural`                   | collection id matches declared plural: chapters                                                                            |
| PASS   | AEP-122 | MUST       | `id-fields-are-strings`                  | all ID path parameters are strings                                                                                         |
| PASS   | AEP-122 | MUST       | `parent-path-is-prefix`                  | publishers/{publisher_id}/books/{book_id} ⊑ publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                |
| PASS   | AEP-122 | MUST       | `path-field-present`                     | path field present                                                                                                         |
| PASS   | AEP-122 | MUST       | `path-field-readonly`                    | path is readOnly                                                                                                           |
| PASS   | AEP-122 | MUST       | `path-matches-canonical-pattern`         | returned path matches canonical pattern: publishers/aepconf-publisher-18/books/aepconf-book-19/chapters/aepconf-chapter-20 |
| PASS   | AEP-122 | MUST       | `path-segments-alternate`                | segments alternate: publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                                        |
| PASS   | AEP-122 | MUST       | `segment-charset-ascii`                  | all literal segments are URL-safe                                                                                          |
| PASS   | AEP-122 | SHOULD NOT | `user-settable-id-not-uuid`              | user-settable id is not a UUID                                                                                             |
| PASS   | AEP-127 | MUST       | `apply-verb-put`                         | PUT /publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                                                       |
| PASS   | AEP-127 | MUST       | `create-verb-post`                       | POST /publishers/{publisher_id}/books/{book_id}/chapters                                                                   |
| PASS   | AEP-127 | MUST       | `delete-verb-delete`                     | DELETE /publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                                                    |
| PASS   | AEP-127 | MUST       | `get-verb-get`                           | GET /publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                                                       |
| PASS   | AEP-127 | MUST       | `list-verb-get`                          | GET /publishers/{publisher_id}/books/{book_id}/chapters                                                                    |
| PASS   | AEP-127 | MUST       | `no-body-delete`                         | no request body                                                                                                            |
| PASS   | AEP-127 | MUST       | `no-body-get`                            | no request body                                                                                                            |
| PASS   | AEP-127 | MUST       | `no-body-list`                           | no request body                                                                                                            |
| PASS   | AEP-127 | SHOULD     | `update-verb-patch`                      | PATCH /publishers/{publisher_id}/books/{book_id}/chapters/{chapter_id}                                                     |
| FAIL   | AEP-130 | MUST       | `operation-id-list-plural`               | List operationId is "ListChapter", want "ListChapters"                                                                     |
| PASS   | AEP-130 | MUST       | `operation-id-standard`                  | standard operationIds well-formed                                                                                          |
| PASS   | AEP-131 | MUST       | `get-200-on-existing`                    | 200 OK                                                                                                                     |
| PASS   | AEP-131 | MUST       | `get-404-on-missing`                     | 404 on missing                                                                                                             |
| PASS   | AEP-131 | MUST       | `get-body-matches-created`               | path matches created resource                                                                                              |
| PASS   | AEP-131 | SHOULD     | `get-fully-populated`                    | resource fully populated                                                                                                   |
| PASS   | AEP-131 | MUST       | `get-path-param-id-form`                 | id path parameter: {chapter_id}                                                                                            |
| PASS   | AEP-131 | MUST       | `get-safe-no-side-effects`               | repeated GET is stable                                                                                                     |
| PASS   | AEP-131 | MUST NOT   | `no-extra-required-query-delete`         | no required query fields                                                                                                   |
| PASS   | AEP-131 | MUST NOT   | `no-extra-required-query-get`            | no required query fields                                                                                                   |
| PASS   | AEP-132 | MUST       | `list-200`                               | 200 OK                                                                                                                     |
...
| PASS   | AEP-133 | MUST       | `create-echoes-input`                    | all sent fields echoed                                                                                                     |
| PASS   | AEP-133 | MUST NOT   | `create-no-required-query`               | no required query fields on Create                                                                                         |
| PASS   | AEP-133 | MUST       | `create-path-field-ignored`              | client path ignored; server path = publishers/aepconf-publisher-18/books/aepconf-book-19/chapters/aepconf-chapter-22       |
| PASS   | AEP-133 | MUST       | `create-populates-path`                  | path = publishers/aepconf-publisher-18/books/aepconf-book-19/chapters/aepconf-chapter-20                                   |
| PASS   | AEP-133 | MUST       | `create-returns-resource`                | create returned resource                                                                                                   |
| PASS   | AEP-134 | MUST       | `update-404-on-missing`                  | 404 on missing update                                                                                                      |
| PASS   | AEP-134 | MUST       | `update-consistent-on-get`               | update observed on subsequent Get                                                                                          |
| PASS   | AEP-134 | SHOULD     | `update-fully-populated`                 | update response fully populated                                                                                            |
...
| N/A    | AEP-136 | MUST       | `custom-verb-snake-case`                 | feature not present in spec                                                                                                |
| FAIL   | AEP-137 | MUST       | `apply-create-201`                       | apply created a resource but returned 200, expected 201                                                                    |
| FAIL   | AEP-137 | MUST       | `apply-preserves-absent-fields`          | omitted field "number" was modified by Apply (1 → <nil>)                                                                   |
| PASS   | AEP-137 | MUST       | `apply-consistent-on-get`                | apply observed on subsequent Get                                                                                           |
| PASS   | AEP-137 | SHOULD     | `apply-fully-populated`                  | apply response fully populated                                                                                             |
| PASS   | AEP-137 | MUST       | `apply-missing-required-400`             | 400 on apply missing a required field                                                                                      |
| PASS   | AEP-137 | MUST       | `apply-response-is-resource`             | apply returned resource                                                                                                    |
